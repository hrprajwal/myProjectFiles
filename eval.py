...
class Evaluate(object):
    ...
    def setup_valid(self):
        ...
        checkpoint = T.load(os.path.join(config.save_model_path, self.opt.load_model),map_location=T.device('cpu'))
    ...
    def print_original_predicted(self, decoded_sents, ref_sents, article_sents, loadfile):
        ...
        filename = "/content/drive/MyDrive/nlp/summarizer/data/summary.txt"
